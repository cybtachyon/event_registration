...
/**
 * Provides dynamic permissions for Registration type of different types.
 *
 * @ingroup event_registration
 *
 */
class RegistrationTypePermissions{
   ...
   *
   * @return array
   *   The RegistrationType by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (RegistrationType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\event_registration\Entity\RegistrationType $type
   *   The RegistrationType type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(RegistrationType $type) {
    $type_id = $type->id();
