 ...
 *
 * @see \Drupal\event_registration\Entity\Registration.
 */
class RegistrationAccessControlHandler extends EntityAccessControlHandler {
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished event_registration entities');
        }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view published event_registration entities');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit event_registration entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete event_registration entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add event_registration entities');
  }
